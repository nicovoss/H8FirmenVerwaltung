...
describe('Status e2e test', () => {
  ...
  it('should load Statuses', async () => {
    ...
    expect(await statusComponentsPage.getTitle()).to.eq('h8FirmenVerwaltungApp.status.home.title');
  ...
  it('should load create Status page', async () => {
    ...
    expect(await statusUpdatePage.getPageTitle()).to.eq('h8FirmenVerwaltungApp.status.home.createOrEditLabel');
  ...
  it('should create and save Statuses', async () => {
    ...
    await promise.all([statusUpdatePage.setStatusBezInput('statusBez')]);
  ...
  it('should delete last Status', async () => {
    ...
    expect(await statusDeleteDialog.getDialogTitle()).to.eq('h8FirmenVerwaltungApp.status.delete.question');
